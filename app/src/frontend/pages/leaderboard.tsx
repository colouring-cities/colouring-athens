        ...
        {(t, { i18n }) => (
          <article>
            <section className="main-col">
              ...
              <form>
                <label>{t('select_number_of_users')}</label>
                <div className="form-group">
                  <div className="form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="number_10">
                      10
                    </label>
                  </div>
                  <div className="form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="number_100">
                      100
                    </label>
                  </div>
                </div>
                <label>{t('select_time_period')}</label>
                <div className="form-group">
                  <div className="form-check-inline">
                    <input
                      type="radio"
                    ...
                    />
                    <label className="form-check-label" htmlFor="time_all">
                    {t('all_time')}
                    </label>
                  </div>
                  <div className="form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="time_7">
                    {t('last_7days')}
                    </label>
                  </div>
                  <div className="form-check-inline">
                    ...
                    />
                    <label className="form-check-label" htmlFor="time_30">
                    {t('last_30days')}
                    </label>
                  </div>
                </div>
