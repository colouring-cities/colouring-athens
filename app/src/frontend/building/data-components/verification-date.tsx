...
interface DateVerificationProps {
  slug: string;
...
class DateVerification extends Component<DateVerificationProps, any> {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    let verify = "Verify";
    let remove_my_verification = "Remove my verification";
    let confirm_current_value = "Confirm that the current value is correct";
