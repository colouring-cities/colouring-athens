...
const CommunityView: React.FunctionComponent<CategoryViewProps> = (props) => {
    ...
    let community_public_ownership_sources_title = dataFields.community_public_ownership_sources.title_en;
    ...
    if (i18next.language === "gr") {
        ...
        community_public_ownership_sources_title = dataFields.community_public_ownership_sources.title_gr;
